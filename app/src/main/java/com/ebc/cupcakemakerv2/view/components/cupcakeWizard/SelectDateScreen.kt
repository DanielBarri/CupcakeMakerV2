...
fun SelectDataScreen(navController: NavController,
    ...
    Column(
        ...
        //En esta columna vamos a colocar las opciones de pickup
        Column(
            ...
            TextField(
                ...
                onValueChange = {newPickupIns -> cupcakeMakerViewModel.onValue(newPickupIns, ViewModelIDs.PickupInstructions.id)},
            ...
            Text(
                text = stringResource(R.string.subtotal, cupcakeMakerViewModel.state.total),
                modifier = Modifier
